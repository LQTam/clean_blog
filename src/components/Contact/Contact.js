...
export default class Contact extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Header title='Contact Me' desc='Have questions? I have answers.' />
                <div>
                            ...
                            <div className="col-lg-8 col-md-10 mx-auto">
                                ...
                                <form name="sentMessage" id="contactForm" noValidate>
                                    ...
                                    <div className="form-group">
                                        <button type="submit" onClick = {() => this.submitForm()} className="btn btn-primary" id="sendMessageButton">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
